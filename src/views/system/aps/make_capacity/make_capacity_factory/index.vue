<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <right-toolbar export-table-file-name="工厂产能" export-table="dataTable" :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" id="dataTable" :data="brandNameList" @selection-change="handleSelectionChange">
      <el-table-column align="center" label="全选" prop="id" type="selection" width="50"/>
      <el-table-column v-for="(item,index) in  tableHeaderList" :key="index+item" :label="item.showName" :prop="item.fieldName" :width="item.width" align="center"/>
...
export default {
  ...
  created() {
    document["pagePath"] = "/apsMakeCapacityFactory";
