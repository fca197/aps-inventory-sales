<template>
  <div>
    ...
    <el-col :span="24">
      ...
      <el-col :span="21">
        <el-col :span="24">
        <el-col :span="3" v-for="(li,i) in apsSchedulingVersionLimit.filter(t=> queryParams.currentDate.includes(t.currentDay))" :key="i">
          <label  :title="li.currentDay">{{li.showName}}</label>:  {{li.currentCount}}/{{li.min}}-{{li.max}}
        </el-col>
        </el-col>
        <el-col :span="24">
