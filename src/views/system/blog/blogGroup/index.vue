<template>
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      ...
      <el-form-item label="组名称" prop="brandName">
        <el-input v-model="queryParams.data.groupName" clearable placeholder="组名称" @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item>
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="博客组编号" prop="statusCode">
          <el-input v-model="form.groupCode" placeholder="请输入编号"/>
        </el-form-item>
        <el-form-item label="博客组名称" prop="groupName">
