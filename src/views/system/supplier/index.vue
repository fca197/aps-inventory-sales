  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      <el-form-item label="供应商名称" prop="supplier">
        <el-input v-model="queryParams.data.supplierName" clearable placeholder="供应商名称" @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item>
...
export default {
  ...
  created() {
    document["pagePath"] = "/baseSupplier";
  ...
  methods: {
    ...
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.supplierList = response.dataList;
