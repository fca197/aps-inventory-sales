  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      <el-form-item label="角色ID" prop="userId">
        <el-input v-model="queryParams.data.userId" clearable placeholder="请输入角色ID" @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="baseUserResourceList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="角色ID" prop="userId">
          <el-input v-model="form.userId" clearable placeholder="请输入角色ID"/>
        </el-form-item>
        <el-form-item label="资源ID" prop="resourceId">
...
export default {
  ...
  created() {
    document['pagePath'] = '/baseUserResource'
    this.getList()
  },
  methods: {
    /** 查询公告列表 */
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.baseUserResourceList = response.dataList
