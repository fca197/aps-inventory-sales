<template>
  <div class="app-container">
    ...
    <el-table ref="tables" v-loading="loading" :data="list" :default-sort="defaultSort" @selection-change="handleSelectionChange" @sort-change="handleSortChange">
      ...
      <el-table-column align="center" label="日志序号" prop="operId"/>
      ...
      <el-table-column :sort-orders="['descending', 'ascending']" align="center" label="操作日期" prop="operTime" sortable="custom" width="160">
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除日志序号为"' + operIds + '"的数据项？').then(function () {
