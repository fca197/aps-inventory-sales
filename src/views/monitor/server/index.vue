          ...
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;">
              ...
              <tr>
                ...
                <td class="el-table__cell is-leaf">
                  <div v-if="server.mem" :class="{'text-danger': server.mem.usage > 80}" class="cell">{{ server.mem.usage }}%</div>
                </td>
                <td class="el-table__cell is-leaf">
                  <div v-if="server.jvm" :class="{'text-danger': server.jvm.usage > 80}" class="cell">{{ server.jvm.usage }}%</div>
                </td>
              </tr>
              </tbody>
            </table>
