...
| 模块    | 列表 | 增加 | 删除 | 修改 | 详情 | 其他        | 备注                    | 需求                            | BUG         | 优化        |
|-------|----|----|----|----|----|-----------|-----------------------|-------------------------------|-------------|-----------|
| 用户管理  | ✅  | ✅  | ✅  | ✅  | ✅  | 登录,登出     | <!-- 备注-->            | <!-- 需求-->                    | <!-- BUG--> | <!--优化--> |
| 租户管理  | ✅  | ✅  | ✅  | ✅  | ✅  | <!--其他--> | <!-- 备注-->            | <!-- 需求-->                    | <!-- BUG--> | <!--优化--> |
| 工厂管理  | ✅  | ✅  | ✅  | ✅  | ✅  | <!--其他--> | <!-- 备注-->            | <!-- 需求-->                    | <!-- BUG--> | <!--优化--> |
| 楼层管理  | ✅  | ✅  | ✅  | ✅  | ✅  | 批量创建      | <!-- 备注-->            | <!-- 需求-->                    | <!-- BUG--> | <!--优化--> |
| 房间管理  | ✅  | ✅  | ✅  | ✅  | ✅  | 批量创建      | <!-- 备注-->            | <!-- 需求-->                    | <!-- BUG--> | <!--优化--> |
| 资产管理  | ✅  | ✅  | ✅  | ✅  | ✅  | 资产禁用,批量创建 | <!-- 备注-->            | <!-- 需求-->增加资产使用人             | <!-- BUG--> | <!--优化--> |
| 盘点管理  | ✅  | ✅  | ✅  | ✅  | ✅  | 扫码盘点,下载   | <!-- 备注-->            | <!-- 需求-->盘点快照                | <!-- BUG--> | <!--优化--> |
| H3接口  |    |    |    |    |    | <!--其他--> | <!-- 备注-->H3 API接口已接入 | <!-- 需求-->                    | <!-- BUG--> | <!--优化--> |
| 文件管理  | ✅  | ✅  | ✅  |    | ✅  | <!--其他--> | <!-- 备注-->            | <!-- 需求-->                    | <!-- BUG--> | <!--优化--> |
| 商品管理  |    |    |    |    |    | <!--其他--> | <!-- 备注-->            | <!-- 需求-->每日盘点,销售数据,库存数据,库存预警 | <!-- BUG--> | <!--优化--> |
| 订单管理  |    |    |    |    |    | <!--其他--> | <!-- 备注-->            | <!-- 需求-->                    | <!-- BUG--> | <!--优化--> |
| 财务管理  |    |    |    |    |    | <!--其他--> | <!-- 备注-->            | <!-- 需求-->收支统计,财务分析,财务报告      | <!-- BUG--> | <!--优化--> |
| 供应商管理 |    |    |    |    |    | <!--其他--> | <!-- 备注-->            | <!-- 需求-->                    | <!-- BUG--> | <!--优化--> |
| 采购管理  |    |    |    |    |    | <!--其他--> | <!-- 备注-->            | <!-- 需求-->                    | <!-- BUG--> | <!--优化--> |
| 消息中心  |    |    |    |    |    | <!--其他--> | <!-- 备注-->            | <!-- 需求-->                    | <!-- BUG--> | <!--优化--> |
