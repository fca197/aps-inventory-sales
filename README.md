...
商品添加: , after goods_list ,3h
商品删除:  , after goods_add ,1d
section 订单管理
...
|  模块   | 列表 | 增加 | 删除 | 修改 | 详情 | 其他              | 备注             | 需求                  | BUG | 优化 | 其他 |
|:-----:|----|----|----|----|----|:----------------|----------------|---------------------|-----|----|----|
| 用户管理  | ✅  | ✅  | ✅  | ✅  | ✅  | 登录,登出           |                |                     |     |    |    |
| 租户管理  | ✅  | ✅  | ✅  | ✅  | ✅  |                 |                |                     |     |    |    |
| 工厂管理  | ✅  | ✅  | ✅  | ✅  | ✅  |                 |                |                     |     |    |    |
| 楼层管理  | ✅  | ✅  | ✅  | ✅  | ✅  | 批量创建            |                |                     |     |    |    |
| 房间管理  | ✅  | ✅  | ✅  | ✅  | ✅  | 批量创建            |                |                     |     |    |    |
| 资产管理  | ✅  | ✅  | ✅  | ✅  | ✅  | 资产禁用,批量创建,生成二维码 | 二维码贴相应资产,盘点需扫码 | 增加资产使用人             |     |    |    |
| 盘点管理  | ✅  | ✅  | ✅  | ✅  | ✅  | 扫码盘点,下载         |                | 盘点快照                |     |    |    |
| H3接口  |    |    |    |    |    |                 | H3 API接口已接入    |                     |     |    |    |
| 文件管理  | ✅  | ✅  | ✅  |    | ✅  |                 |                |                     |     |    |    |
| 商品管理  |    |    |    |    |    |                 |                | 每日盘点,销售数据,库存数据,库存预警 |     |    |    |
| 订单管理  |    |    |    |    |    |                 |                |                     |     |    |    |
| 财务管理  |    |    |    |    |    |                 |                | 收支统计,财务分析,财务报告      |     |    |    |
| 供应商管理 |    |    |    |    |    |                 |                |                     |     |    |    |
| 采购管理  |    |    |    |    |    |                 |                |                     |     |    |    |
